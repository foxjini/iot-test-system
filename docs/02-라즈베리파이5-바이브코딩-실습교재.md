# 라즈베리파이 5 & Antigravity AI 기반 IoT 캡스톤 바이브 코딩 실습교재

> 📂 **본편 02 / 라즈베리파이 담당 / 01이 돌아간 뒤** — Lab 0~6 실습 · 전체 목록 [docs/README.md](README.md)
...
> 로직(4~5장, `부록A-센서-액추에이터-17종-프롬프트-모음.md`)은 그대로 재사용합니다. 백엔드 학생과
> 함께 그 전환을 확인하는 절차는 `03-진짜-백엔드-연동-확인-매뉴얼.md`를 따릅니다.
...
> [`부록A-센서-액추에이터-17종-프롬프트-모음.md`](부록A-센서-액추에이터-17종-프롬프트-모음.md)에 4장·5장과 같은 형식으로
